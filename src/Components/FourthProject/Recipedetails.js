...
export default class Recipedetails extends Component {
    ...
    //     this.state = {
    //         recipe: recipe,
    //         url:`https://www.food2fork.com/api/get?key=93a0cf0e7a310ab3c2a49cfcf18e8186&rId=${this.props.id}`
    //     };
    // }
    ...
    async componentDidMount(){
       ...
       const url=`https://www.food2fork.com/api/get?key=93a0cf0e7a310ab3c2a49cfcf18e8186&rId=${id}`;
          try{
